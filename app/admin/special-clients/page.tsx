...
export default function SpecialClientsPage() {
  ...
  const handleAssignVIP = async () => {
    ...
    alert("Cliente asignado como VIP exitosamente");
  };
      ...
      <div className="bg-white border border-slate-100 rounded-3xl overflow-hidden shadow-sm">
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-slate-50">
            {loading ? (
              <tr><td colSpan={5} className="text-center py-20 text-slate-400 italic">Cargando clientes...</td></tr>
            ) : (
