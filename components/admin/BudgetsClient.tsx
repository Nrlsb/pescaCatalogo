  ...
  return (
    <div className="p-8 animate-in">
      ...
      <Modal 
        ...
        title={`Crear Nuevo Presupuesto (${products.length} productos cargados)`}
        size="lg"
      >
        <div className="space-y-6">
              ...
              {newBudget.items.map((item, index) => (
                <div key={index} className="flex gap-3 items-end">
                  <div className="flex-[3]">
                    <select 
                      className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none appearance-none cursor-pointer"
          ...
          <div className="pt-6 flex gap-3 border-t">
            ...
            <Button onClick={handleCreateBudget} className="flex-1" disabled={!newBudget.customerName}>
              Generar Presupuesto
            </Button>
          </div>
        </div>
